                ...
                {CoachingExperts.map((expert, index) => (
                  ...
                  >
                    <Image
                      ...
                      width={100}
                      height={100}
                      className={`rounded-2xl h-16 w-20 object-cover hover:scale-105 transition-all p-1 border-primary cursor-pointer ${selectedExpert === expert.name && "border"}`}
                    />
                    <h2 className="text-center text-xs">{expert.name}</h2>
                  </div>
                ))}
              </div>
